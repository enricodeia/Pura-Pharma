document.addEventListener("DOMContentLoaded", function () {
    let currentIndex = 0;
    const totalSlides = 8; // Adjust if you have more slides
    ...
    const productSubs = document.querySelectorAll(".product_sub");
    const imageBoxes = document.querySelectorAll(".image_box");
    const productParagraphs = document.querySelectorAll(".product_paragraph");
